...
public class BabyDao {
	...
	public static Connection getCon(){
		...
		try{
			...
			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/babycare?serverTimezone=UTC","root","linda12345");
	...
	public static int save(Baby b){
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("insert into babyname(name,meaning,gender,religion) values(?,?,?,?)");
